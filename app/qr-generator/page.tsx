            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur p-6 md:p-8">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  onClick={downloadQR}
                  disabled={!qrDataUrl}
                  className="flex items-center justify-center gap-2 rounded-xl bg-purple-600 px-5 py-3 text-sm font-semibold transition-all hover:scale-105 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:scale-100"
                >
                  <Download size={18} />
                  Download
                </button>
              ...
              <div className="mt-6 rounded-xl border border-purple-400/20 bg-purple-400/10 p-4">
                <p className="text-xs text-purple-100">
                  <strong>Tips:</strong> QR code dapat dibaca oleh aplikasi
                  kamera smartphone atau aplikasi QR scanner. Pastikan ukuran
